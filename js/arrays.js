...
document.write('<h1>Estadísticas Centro Medico Ñuñoa</h1>');
...
//Agregar código para el desafio 2 aquí
    ...
    //document.write(`<p>${var dental_list = dental.join("-")//}</p>`);
    ...
    {
        document.write(`<p> ${atentionAll[index].paciente} </p>`);
    }
    ...
    dental.map(changePrev);

    function printPrev (elemento, index, array) {
    document.write(`<p> ${dental[index].paciente} ; ${dental[index].rut} ; ${dental[index].prevision} </p>`);
    }
